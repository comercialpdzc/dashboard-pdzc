          ...
          <header className="sticky top-0 z-30 border-b border-white/10 bg-slate-950/90 backdrop-blur-xl">
            <div className="mx-auto flex max-w-[1600px] flex-col gap-4 px-4 py-4 md:px-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex min-w-0 items-start gap-3">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.04] xl:hidden">
                  <img
                    src={LOGO_URL}
                    alt="PDZC"
                ...
                <div className="min-w-0">
                  <div className="inline-flex max-w-full items-center rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] text-slate-300">
            ...
            <div className="border-t border-white/10 xl:hidden">
              <div className="mx-auto max-w-[1600px] overflow-x-auto px-4 py-3 md:px-6">
                  ...
                  {navItems.map((item) => {
                    ...
                    return (
                      <button
                        key={item.key}
                        onClick={() => setActiveView(item.key)}
                        className={`rounded-2xl px-4 py-2 text-sm whitespace-nowrap transition ${
                          active
